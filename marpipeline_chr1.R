MARPIPELINE<-function(
  ...
  REDO_GENOME=FALSE,
  REDO_GENEMAPS=FALSE,
  REDO_MARSAMPLING=FALSE,
  REDO_MAR=TRUE,
  REDO_EXTINCTION=TRUE,
  # ****************** #
  # path to store
  # Adjust the paths based on the chromosome number
  mypath="/netscratch/dep_coupland/grp_fulgione/siva/lfmm/all/chr1/results_mar", 
  freqfile="/netscratch/dep_coupland/grp_fulgione/siva/lfmm/all/chr1/chr1.frq", 
  famfile="/netscratch/dep_coupland/grp_fulgione/siva/lfmm/all/chr1/chr1.fam", 
  mapfile="/netscratch/dep_coupland/grp_fulgione/siva/lfmm/all/chr1/chr1.map",
  bedfile="/netscratch/dep_coupland/grp_fulgione/siva/lfmm/all/chr1/chr1.bed",
  latlonfile="/netscratch/dep_coupland/grp_fulgione/siva/lfmm/933latlong.csv",
  # ****************** #
  debug=TRUE,
  saveobjects=TRUE
){
...
if(REDO_MAR){
  ...
  if(dim(tmpemar)[1] == 0 | length(unique(tmpemar$E))<3){
